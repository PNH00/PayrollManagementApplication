...
public class GUI_QuanLyLuongNhanVien extends JFrame implements ActionListener, MouseListener {
	...
	public GUI_QuanLyLuongNhanVien() {
		...
		lblNewLabel_9.setBounds(1020, 27, 133, 14);
		...
		lblNewLabel_10.setBounds(1170, 27, 133, 14);
		...
		comboBox_Thang.setBounds(1041, 24, 51, 22);
		...
		lblNewLabel_7.setBounds(922, 28, 115, 14);
		panel_1.add(lblNewLabel_7);
		
		JLabel lblNewLabel_8 = new JLabel("Năm tính lương:");
		lblNewLabel_8.setBounds(1119, 28, 97, 14);
