...
//		}
		...
		panel_1.setToolTipText("ThÃ´ng Tin Ä�Äƒng Nháº­p");
		...
		JLabel lblNewLabel = new JLabel("ThÃ´ng Tin Ä�Äƒng Nháº­p");
		...
		JLabel lblNewLabel_2 = new JLabel("ThÃ nh PhÃ¡t Company");
		...
		JLabel lblNewLabel_1_1 = new JLabel("Máº­t kháº©u:");
		...
		btnngNhp = new JButton("  Ä�Äƒng Nháº­p");
	...
	Object o = e.getSource();
		...
		if(o.equals(btnngNhp)) {
			if(txtUserName.getText().equals("")) {
				JOptionPane.showMessageDialog(this, "ChÃº Ã½: Vui lÃ²ng nhÃ¢p tÃ i khoáº£n!");
			}else {
				if(txtPassWord.getText().equals("")) {
					JOptionPane.showMessageDialog(this, "ChÃº Ã½: Vui lÃ²ng Nháº­p Máº­t Kháº©u!");
				}else {
					...
					try {
						...
						if(rs.next()){
							...
							JOptionPane.showMessageDialog(this, "Ä�Äƒng nhÃ¢p tháº¥t báº¡i!");
						}
					} catch (Exception e2) {
						e2.printStackTrace();
					}
