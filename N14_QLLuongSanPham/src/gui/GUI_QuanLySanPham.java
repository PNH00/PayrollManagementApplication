...
//	Thuộc tính
	 ...
	 * Create the frame.
	 */
//	Hàm khởi tạo màn hình quản lý sản thẩm
...
//		Kết nối cơ sở dữ liệu và khởi tạo các đối tượng truy xuất tới CSDL
//		try{
...
//	Hàm đọc dữ liệu vào bảng sản phẩm
...
//	Hàm đọc dữ liệu vào bảng loại sản phẩm
...
//	Đọc mã loại sản phẩm vào comboboxLoaiSP
...
//	Hàm kiểm tra cú pháp nhập liệu thông tin sản phẩm
...
//	Hàm kiểm tra cú pháp nhập liệu thông tin loại sản phẩm
...
//	Bắt sự kiện click trên bảng sản phẩm
...
//	Bắt sự kiện click trên bảng loại sản phẩm
